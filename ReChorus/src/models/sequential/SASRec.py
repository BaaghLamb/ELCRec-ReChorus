...
""" SASRec
CMD example:
	python main.py --model_name SASRec --dataset 'Grocery_and_Gourmet_Food' --epoch 1 --batch_size 32 --emb_size 16 --num_layers 1 --num_heads 2 --lr 1e-3 --l2 1e-6 --early_stop 0 --num_workers 0
Reference:
